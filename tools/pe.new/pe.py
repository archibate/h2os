...
class Contraint:
    ...
    __slots__ = ['a', 'b', 'distance', 'strength']

    def __init__(c, a, b, **kwargs):
        c.a, c.b = a, b
        c.distance = kwargs.get('distance', a.pos.distance(b.pos))
        c.strength = kwargs.get('strength', 100)

    def apply(c):
        disp = c.a.pos - c.b.pos
        disp -= disp.norm * c.distance
        disp *= c.strength
        print(disp * c.a.invmass)
        print('!', c.a.acc)
        c.a.acc -= c.a.invmass * disp
        c.b.acc += c.b.invmass * disp
        print('?', c.a.acc)
...
#        pass#game.world.contraint(last_pt, pt)
#    game.world.add(pt)
#    last_pt = pt
ballA = Circle(pos=(game.hwidth * 1.00, game.hheight * 0.1), radius=game.hheight * 0.04)
ballB = Circle(pos=(game.hwidth * 1.00, game.hheight * 0.2), radius=game.hheight * 0.04)
stat = Circle(pos=(game.hwidth, game.hheight), radius=game.hheight * 0.3)
game.world.add(ballA)
game.world.add(ballB)
game.world.add_static(stat)
game.world.contraint(ballA, ballB)
game.mainloop()
